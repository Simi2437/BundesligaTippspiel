...
from app.backend.models.spieltage import get_all_spieltage, get_spiele_by_spieltag, add_spiel, update_spiel, delete_spiel
from app.backend.models.teams import get_all_teams
from app.backend.models.tipps import count_tipps_for_spiel
from app.backend.services.auth_service import current_user, is_admin_user
